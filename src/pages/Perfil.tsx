...
export default function Perfil() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-gray-900">Perfil</h2>
        ...
        <Card className="md:col-span-1">
          ...
          <CardContent className="text-center">
            <Avatar className="mx-auto h-24 w-24 mb-4">
              ...
              <AvatarFallback className="text-lg bg-gradient-to-r from-green-100 to-blue-100 text-green-700">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <p className="font-medium text-gray-700">Status da conta</p>
